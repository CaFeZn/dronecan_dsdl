 ...
 public:
  ...
  DroneCANDsdl(LibXR::HardwareContainer& hw,
      ...
      : can_(*hw.FindOrExit<LibXR::CAN>({NormalizeCString(can_alias, "can0")})),
        ...
        uavcan_equipment_esc_raw_command_topic_(LibXR::Topic::CreateTopic<UavcanEquipmentEscRawCommandTopicData>(kUavcanEquipmentEscRawCommandTopicName)),
        uavcan_equipment_esc_status_topic_(LibXR::Topic::CreateTopic<UavcanEquipmentEscStatusTopicData>(kUavcanEquipmentEscStatusTopicName)),
        uavcan_protocol_dynamic_node_id_allocation_topic_(LibXR::Topic::CreateTopic<UavcanProtocolDynamicNodeIdAllocationTopicData>(kUavcanProtocolDynamicNodeIdAllocationTopicName)),
        uavcan_equipment_esc_raw_command_tx_topic_(LibXR::Topic::CreateTopic<UavcanEquipmentEscRawCommandTopicData>(kUavcanEquipmentEscRawCommandTxTopicName)),
        uavcan_equipment_esc_status_tx_topic_(LibXR::Topic::CreateTopic<UavcanEquipmentEscStatusTopicData>(kUavcanEquipmentEscStatusTxTopicName)),
        uavcan_protocol_dynamic_node_id_allocation_tx_topic_(LibXR::Topic::CreateTopic<UavcanProtocolDynamicNodeIdAllocationTopicData>(kUavcanProtocolDynamicNodeIdAllocationTxTopicName)),
